...
- (void) storeRawProfile:(NSDictionary *)rawProfile {
    ...
    [self updateProfileAttributesFromSource:rawProfile];
    
    [self updateCurrentVisitFromSource:rawProfile];
}
...
- (void) updateProfileAttributesFromSource:(NSDictionary *)source {
    ...
    [self updateAudiencesFromSource:source];
    [self updateBadgesFromSource:source];
...
- (void) updateAudiencesFromSource:(NSDictionary *)source {
...
- (void) updateBadgesFromSource:(NSDictionary *)source {
...
- (void) updateCurrentVisitFromSource:(NSDictionary *)source {
    ...
    [visit storeRawCurrentVisit:sourceVisit];
